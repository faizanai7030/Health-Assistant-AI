...
import { LayoutDashboard, Users, Calendar, MessageSquare, MessageCircleCode, Bell } from "lucide-react";
    ...
    <div className="flex h-screen bg-background w-full">
      ...
      <aside className="w-64 border-r bg-card flex flex-col hidden md:flex">
        <div className="p-6 border-b flex items-center space-x-3">
          ...
          <span className="font-bold text-lg tracking-tight text-foreground">ClinicAI</span>
        </div>
      ...
      <main className="flex-1 flex flex-col overflow-hidden w-full">
        ...
        <header className="md:hidden border-b bg-card p-4 flex items-center justify-between">
          <div className="font-bold text-lg text-foreground">ClinicAI</div>
